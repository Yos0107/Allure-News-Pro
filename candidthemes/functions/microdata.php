 ...
 */
if (!function_exists('allure_news_get_microdata')) :
    function allure_news_get_microdata($context)
    {
        $data = false;

        if ('microdata' !== apply_filters('allure_news_schema_type', 'microdata')) {
            return false;
        }
        ...
        if ('body' === $context) {
            ...
            $type = apply_filters('allure_news_body_itemtype', $type);
        ...
        if ('article' === $context) {
            $type = apply_filters('allure_news_article_itemtype', 'CreativeWork');
        ...
        if ($data) {
            return apply_filters("allure_news_{$context}_microdata", $data);
        }
    }
endif;
 ...
 */
if (!function_exists('allure_news_do_microdata')) :
    function allure_news_do_microdata($context)
    {
        echo allure_news_get_microdata($context); // WPCS: XSS ok, sanitization ok.
    }
endif;