...
if (!function_exists('allure_news_constuct_fourth_carousel')) {
    /**
     * Add carousel on header
     *
     * @since 1.0.0
     */
    function allure_news_constuct_fourth_carousel()
    {
        ...
        if (is_front_page()) {
            ...
            //echo $count;
            ?>
            <div class="allure-news-featured-block allure-fourth-carousel allure-news-ct-row clearfix">
                <?php
...
add_action('allure_news_carousel_four', 'allure_news_constuct_awesome_carousel', 10);