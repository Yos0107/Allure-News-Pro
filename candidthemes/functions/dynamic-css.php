...
if (!function_exists('allure_news_dynamic_css')) :
    ...
    function allure_news_dynamic_css()
    {
        ...
        if (!empty($allure_news_theme_options['allure-news-site-title-hover'])) {
            ...
            $allure_news_custom_css .= ".ct-dark-mode .site-title a:hover, .site-title a:hover, .site-title a:visited:hover, .ct-dark-mode .site-title a:visited:hover, .allure-news-logo-container .site-title a:hover { color: {$allure_news_site_title_hover_color}; }";
        }
...
.about-author-box .container-title  { font-family: '{$allure_news_widget_font_family}'; }";
        ...
        if (!empty($allure_news_primary_color)) {
            //font-color
            $allure_news_custom_css .= ".entry-content a, .entry-title a:hover, .related-title a:hover, .posts-navigation .nav-previous a:hover, .post-navigation .nav-previous a:hover, .posts-navigation .nav-next a:hover, .post-navigation .nav-next a:hover, #comments .comment-content a:hover, #comments .comment-author a:hover, .offcanvas-menu nav ul.top-menu li a:hover, .offcanvas-menu nav ul.top-menu li.current-menu-item > a, .error-404-title, #allure-news-breadcrumbs a:hover, .entry-content a.read-more-text:hover, a:hover, a:visited:hover, .allure-news-social-top .allure-news-menu-social li a:hover::before, .ct-menu-search .search-icon-box:hover, .search-icon-box:hover i, .slick-next:before, .slick-prev:before { color : {$allure_news_primary_color}; }";
            ...
            .about-author-box .container-title:before, .widget ul.ct-nav-tabs:before, .widget ul.ct-nav-tabs li.ct-title-head:hover, .widget ul.ct-nav-tabs li.ct-title-head.ui-tabs-active, .main-navigation ul li a:before, .main-navigation ul li a:before, .main-navigation ul li.current-menu-item a:before, #toTop:hover{ background-color : {$allure_news_primary_color}; }";
...
.about-author-box .container-title  { font-size : {$allure_news_widget_font_size}px; }";
        ...
        */
        ...
        if(!empty($allure_news_theme_options['allure-news-body-text-color'])){
            ...
            $allure_news_custom_css .= "body, .slide-details, .slide-details a:visited, .slide-details:hover a, #allure-news-breadcrumbs a, #allure-news-breadcrumbs a:visited, .entry-meta a, .entry-footer a, .entry-meta a:visited, .entry-footer a:visited, .entry-title, .entry-title a, .entry-title a:visited, .related-post-entries .entry-meta, .related-post-entries, .related-post-entries a, .related-post-entries a:visited, .entry-content a.read-more-text{ color : {$body_text_color}; }";
        }
        ...
        if(!empty($allure_news_theme_options['allure-news-site-title'])){
            $sitetitle_color = $allure_news_theme_options['allure-news-site-title'];
            $allure_news_custom_css .= " .allure-news-logo-container .site-title a { color : {$sitetitle_color}; }";
        }
