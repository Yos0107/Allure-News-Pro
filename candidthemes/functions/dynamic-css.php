...
.about-author-box .container-title  { font-family: '{$allure_news_widget_font_family}'; }";
        ...
        if (!empty($allure_news_primary_color)) {
            ...
            .about-author-box .container-title:before, .widget ul.ct-nav-tabs:before, .widget ul.ct-nav-tabs li.ct-title-head:hover, .widget ul.ct-nav-tabs li.ct-title-head.ui-tabs-active, .cat-links a, .main-navigation ul li a:before, .main-navigation ul li a:before, .main-navigation ul li.current-menu-item a:before{ background-color : {$allure_news_primary_color}; }";
