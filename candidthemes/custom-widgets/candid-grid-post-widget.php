 ...
 * @since 1.0.0
 */
if (!class_exists('Allure_News_Grid_Post')) :
     ...
     * @since 1.0.0
     */
    class Allure_News_Grid_Post extends WP_Widget
    {
        private function defaults()
        {
            $defaults = array(
                'title'    => esc_html__( 'Grid Posts News', 'allure-news' ),
                'cat'     => 0,
                'post-number' => 5,
                'post-date'=> 1,
                'show-category'=> 1,
        ...
        {
            $opts = array(
                'classname' => 'allure-news-grid-post',
                'description' => esc_html__('Help to display content in Grid Layout.', 'allure-news'),
            );

            parent::__construct('allure-news-grid-post', esc_html__('Allure News Grid Post', 'allure-news'), $opts);
        }
        ...
        public function widget($args, $instance)
        {
            ...
            $show_post_date = !empty($instance['post-date']) ? $instance['post-date'] : '0';
            ...
            $excerpt_length = !empty($instance['excerpt-length']) ? $instance['excerpt-length'] : 25;
                        ...
                        <div class="ct-three-cols">
                            <section class="ct-grid-post-list">
                                ...
                                <div class="post-content mt-10">
                                    ...
                                    <?php if ($show_post_date == 1 || $hide_read_time != 1) { ?>
                                        <div class="post-meta">
                                            <?php
                                            if ($show_post_date == 1){
