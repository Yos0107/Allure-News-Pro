...
if (!class_exists('Allure_News_Featured_Post')) :
    ...
    class Allure_News_Featured_Post extends WP_Widget
    {
        ...
        public function widget($args, $instance)
        {
            ...
            $f_excerpt_length = !empty($instance['f-excerpt-length']) ? $instance['f-excerpt-length'] : 15;
            if (!empty($title)) {
        ...
        function form($instance)
        {
            ...
            <p>
                ...
                <input class="widefat ct-show-hide" id="<?php echo esc_attr($this->get_field_id('show_content')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('show_content')); ?>" type="checkbox"
                       value="<?php echo $show_content; ?>" <?php checked(($instance['show_content'] == 1) ? $instance['show_content'] : 0); ?>/>
            </p>
            <p>
                <label
