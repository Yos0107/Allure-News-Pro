 ...
 * @package Allure News
 */
if (!class_exists('Allure_News_Advertisement_Widget')) :
    /**
     * Advertisement widget class.
     *
     * @since Allure News 1.0.0
     */
    class Allure_News_Advertisement_Widget extends WP_Widget {

        function __construct() {
            $opts  = array(
                'classname'                   => 'allure_news_advertisement',
                'description'                 => __( 'Small (125*125) Advertisement.', 'allure-news' ),
                'customize_selective_refresh' => true,
            );
            $control_ops = array( 'width' => 200, 'height' => 250 );
            parent::__construct( false, $name = __( 'Allure News(125*125) Advertisement', 'allure-news' ), $opts );
        }
     ...
     */
        ...
        for ( $i = 1; $i < 9; $i ++ ) {
            $image_link = 'allure_news_ads_image_link_' . $i;
            $image_url  = 'allure_news_ads_image_url_' . $i;
    ...
    function update( $new_instance, $old_instance ) {
        ...
        function form( $instance ) {
            // Defaults.
            $defaults = array(
                'title'                => esc_html__('Advertisement', 'allure-news'),
                'allure_news_ads_image_url_1'  => '',
                'allure_news_ads_image_url_2'  => '',
                'allure_news_ads_image_url_3'  => '',
                'allure_news_ads_image_url_4'  => '',
                'allure_news_ads_image_url_5'  => '',
                'allure_news_ads_image_url_6'  => '',
                'allure_news_ads_image_url_7'  => '',
                'allure_news_ads_image_url_8'  => '',
                'allure_news_ads_image_link_1' => '',
                'allure_news_ads_image_link_2' => '',
                'allure_news_ads_image_link_3' => '',
                'allure_news_ads_image_link_4' => '',
                'allure_news_ads_image_link_5' => '',
                'allure_news_ads_image_link_6' => '',
                'allure_news_ads_image_link_7' => '',
                'allure_news_ads_image_link_8' => '',
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'allure-news' ); ?></label>
                <input id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $title; ?>" />
            </p>
            <label><?php _e( 'Add your Advertisement 125x125 Images Here', 'allure-news' ); ?></label>
            <?php
            for ( $i = 1; $i < 9; $i ++ ) {
                $image_link = 'allure_news_ads_image_link_' . $i;
                $image_url  = 'allure_news_ads_image_url_' . $i;
                ?>
                <p>
                    <label for="<?php echo $this->get_field_id( $image_link ); ?>"> <?php _e( 'Advertisement Image Link ', 'allure-news' );
                    echo $i; ?></label>
                ...
                <p>
                   <label for="<?php echo $this->get_field_id($image_url); ?>">
                    <?php _e('Upload Advertisement Image', 'allure-news'); ?>
                </label>
...
add_action('admin_enqueue_scripts', 'allure_news_ads_widgets_backend_enqueue');
function allure_news_ads_widgets_backend_enqueue()
{
