...
if (!class_exists('Allure_News_Thumb_Posts')) :
    ...
    class Allure_News_Thumb_Posts extends WP_Widget
    {
        ...
        public function form($instance)
        {
            ...
            $layout_arrays = array( __('Column 1','allure-news'), __('Column 2','allure-news'), __('Column 3','allure-news'),  __('Column 4','allure-news')  );
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'column_number_layout' ); ?>">
                    <?php _e( 'Select the column number', 'allure-news' ); ?>
                </label>
